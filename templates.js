        ...
        <div class="description">
            ...
            <div class="iconInfos">
                ...
                <div class="icon" style="text-align: left;">
                    <h2 style="text-align: center;">Infos für den Spielleiter:</h2>
                    <p>1. Wähle die Teamanzahl<br>
                        2. Trage die Teamnamen ein<br>
                        3. Auf Wunsch ändere mit <img class="jackpotIMG" src="./img/color.png"> die Teamfarbe<br>
                        4. Bestimme das startende Team durch klicken auf den Kontostand<br>
                        5. Einer pro Team bestimmt eine Wolke durch Benennen der Nummer<br>
                        6. Klicke auf die ausgewählte Wolke<br>
                        7. Möchte das Team sichern, klicke auf "Sichern"<br>
                        8. Das <img class="jackpotIMG" src="./img/jackpot.png"> zeigt den Inhalt des Jackpots an<br>
                        9. Jedes Team MUSS mind. 1 Wolke wählen, bevor es sichert.
                    </p>
                </div>
            </div>
            <div class="author">
